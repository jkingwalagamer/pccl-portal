...
<body style="background-image: linear-gradient(40deg, #7FFFD4 0%, #00FFFF 100%);">
    ...
    <div id="buttons" style="position: relative; text-align:center; bottom: 50%;">
        <H1 style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-style: normal; font-size: 50px;">PCCL Productiom</H1>
        <?php
